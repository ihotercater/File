var music_domain = 'player.qsdurl.cn';
...
if (navigator.userAgent.match(/(iPhone|iPod|iPad|Android|ios|Nokia|Black Berry|MIDP|Phone)/i) && mobiles === "no") {
    ...
    if (myhkLoad && window.location.href.indexOf(music_domain) < 0) {
        $("#myhkplayer").hide()
    } else {
        var songSheetList;
        var webURL = 'https://' + music_domain +'/';
        var keyId = $("#xplayer").attr("key");
        console.log("小枫音乐播放器插件：" + webURL);
        localStorage.setItem("myhkLoad", "true");
        $("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"https://"+ music_domain +"/Static/player12/css/player.css\">").append('<link rel=\"stylesheet\" type=\"text/css\" href=\"https://'+ music_domain +'/Static/player12/icon/iconfont.css\">');
        ...
        $("body").append("<div id=\"myhkplayer\">" +
            ...
            "            <div class=\"timestyle\"><span class=\"time xf_timerP\"><i class=\"xf_time1\">00:00</i><i class=\"xf_time2\">00:00</i></span></div>" +
            ...
            // "        <div class=\"cover\"></div>" +
            "        <div class=\"infos\">" +
            "            <div class=\"songstyle\"><div class=\"name\"><span class=\"song\"></span></div></div>" +
            "            <div class=\"artiststyle\"><span class=\"artist\"></span><span class=\"moshi\"><i" +
            ...
            "                   </div>" +
            "             </div > " +
            "            <i class=\"aprev iconfont icon-shangyishoushangyige\" title=\"上一专辑\"></i>" +
            "            <i class=\"prev iconfont icon-shangyishou\" title=\"上一首\"></i>" +
            // "            <div class=\"status\">" +
            // "               <b>" +
            "                    <i class=\"play iconfont icon-bofang\" title=\"播放\"></i>" +
            "                    <i class=\"pause iconfont icon-weibiaoti519\" title=\"暂停\"></i>" +
            ...
            // "               </b>" +
            // "            </div>" +
            "            <i class=\"next iconfont icon-xiayishou\" title=\"下一首\"></i>" +
            "            <i class=\"anext iconfont icon-xiayigexiayishou\" title=\"下一专辑\"></i>" +
            "            <div class=\"xf_music_ksks\">" +
            "               <span class=\"qhms\">" +
            "                   <i class=\"fa fa-random\" title=\"随机播放\"></i>" +
            "               </span>" +
            "               <span class=\"switch-ksclrc\">" +
            ...
            "        </div>" +
            "    </div>" +
            "    <div class=\"switch-player\" style=\"display: block;\">" +
        ...
        if (top.location != self.location) {
            ...
            var audio = new Audio(),
                ...
                $cover = $(".cover", $player),
                $xf_time1 = $(".xf_time1", $player),
                $xf_time2 = $(".xf_time2", $player)
            ...
            function myhkCicle() {
                $xf_time1.text(formatSecond(audio.currentTime))
                $xf_time2.text(formatSecond(audio.duration))
            }
            ...
            $songFrom.html("<a style=\"color:#f00\">小枫</a>");
                ...
                creat: {
                    album: function () {
                        if (typeof myhkid === "undefined") {
                            ...
                            $(".musicheader", $albumList).html("<a href=\"" + webURL + "\" title=\"欢迎使用小枫播放器</a>")
                        };
            ...
            $.ajax({
                ...
                success: function () {
                    if (typeof myhkid !== "undefined") {
                        $(".myhkgeci", $player).html("<a style=\"float: right\" href=\"" + webURL + "\" title=\"小枫播放器\" target=\"_blank\"><i class=\"fa fa-share-alt\"></i> 免费申请</a>");
...
function xf_play() {
    ...
    let xf_player = document.querySelector('#myhkplayer')
    let music_box = document.querySelector('.xf_music_box')
    let xf_bg = document.querySelector('.blur')
    ...
    xf_player.addEventListener('mouseover', function () {
        music_box.style.top = '38%'
        xf_bg.style.transform = 'scale(1.2)'
    })
    xf_player.addEventListener('mouseleave', function () {
        music_box.style.top = '68%'
        xf_bg.style.transform = 'scale(1)'
    })
}
xf_play()